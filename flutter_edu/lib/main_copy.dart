...
import 'com/doudou/gc/anim/transition.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 1,
        items: [
          BottomNavigationBarItem(icon: Image.asset("images/ic_app_list_dark.png", width: 27), label: "游戏"),
          BottomNavigationBarItem(icon: Image.asset("images/ic_featured_dark.png", width: 27), label: "精选"),
          BottomNavigationBarItem(icon: Image.asset("images/ic_mine_dark.png", width: 27), label: "我的"),
        ],
      ),
    );
  }
